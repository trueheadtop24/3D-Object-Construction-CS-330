...
// LAST REVISED: Novbember 15, 2025
//
// RESPONSIBILITIES:
...
void SceneManager::RenderScene()
{
	...
	SetTransformations(
		...
		ZrotationDegrees,
		positionXYZ);
	// set the color values into the shader to a light pink color
	SetShaderColor(1, 0.8, 0.9, 1);
	...
	/* creating a stretched cube*/

	scaleXYZ = glm::vec3(2.5f, 1.0f, 1.0f);
	XrotationDegrees = 0.0f;
	YrotationDegrees = 0.0f;
	ZrotationDegrees = 0.0f;
	positionXYZ = glm::vec3(-6.0f, 0.5f, -5.5f);
	...
	scaleXYZ = glm::vec3(1.0f, 2.5f, 1.0f);     // tall skinny cone
	XrotationDegrees = 0.0f;
	YrotationDegrees = 0.0f;
	ZrotationDegrees = 0.0f;
	// placed roughly on top of the cube
	positionXYZ = glm::vec3(-1.5f, 3.5f, -6.0f);
	...
	// tan / beige color
	SetShaderColor(0.85f, 0.60f, 0.40f, 1.0f);
	m_basicMeshes->DrawConeMesh();
	/*****************************************************************/

	/*************** PINK SPHERE IN FRONT ****************************/
	scaleXYZ = glm::vec3(1.4f, 1.4f, 1.4f);
	XrotationDegrees = 0.0f;
	YrotationDegrees = 0.0f;
	ZrotationDegrees = 0.0f;
	positionXYZ = glm::vec3(0.5f, 1.4f, -4.5f);
	...
	// pink sphere
	SetShaderColor(1.0f, 0.60f, 0.80f, 1.0f);
	m_basicMeshes->DrawSphereMesh();
	/*****************************************************************/

	/*************** TALL RIGHT BOX (stretched cube) *****************/
	scaleXYZ = glm::vec3(2.0f, 6.0f, 2.0f);     // tall rectangular box
	XrotationDegrees = 0.0f;
	YrotationDegrees = 0.0f;
	ZrotationDegrees = 0.0f;
	positionXYZ = glm::vec3(4.0f, 3.0f, -6.5f);
	...
	YrotationDegrees = 0.0f;
	ZrotationDegrees = 0.0f;
	positionXYZ = glm::vec3(2.0f, 3.0f, -8.5f);
